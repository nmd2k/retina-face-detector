...
class WiderFacePreprocess(object):
    def __init__(self, image_size = INPUT_SIZE):
        self.img_size = image_size
        

    def __call__(self, image, targets):    
        assert targets.shape[0] > 0, "This images does not have ground truth"
        ...
        # targets_t = torch.from_numpy(targets_t)
